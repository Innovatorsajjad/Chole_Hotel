...
const Header = () => {
    return (
        <div>
            <div className="FullNav py-3 bg-white ">
                ...
                <div className="Logo w-24 flex md:justify-center ">
                    <img  className='rounded-full md:inline-block' src="https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/31aebd40883975.5790c3474c6a6.jpg" alt="" />
                </div>
