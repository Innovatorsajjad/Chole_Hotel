    ...
    return (
        <div>
            <div className="allitems container mx-auto my-20 md:max-w-4xl">
                ...
                <div data-aos="fade-right" className="firstitem flex md:flex-row md:justify-between gap-5 my-5 flex-col-reverse">
                ...
                <div data-aos="fade-left" className="seconditem flex md:flex-row flex-col gap-5 my-16 px-4">
                ...
                <div data-aos="fade-right" className="thirditem flex md:flex-row gap-5 my-5 px-4 flex-col-reverse">
